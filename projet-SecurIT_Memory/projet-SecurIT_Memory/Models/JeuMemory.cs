...
namespace SecurIT_Memory.Models
{
    ...
    public class JeuMemory
    {
        ...
        private void InitialiserCartes(int nombreDePaires)
        {
            ...
            string[] banqueImages = {
                "Ressources/Images/virus.png", "Ressources/Images/parefeu.png", "Ressources/Images/cadenas.png",
                "Ressources/Images/mdp.png", "Ressources/Images/hacker.png", "Ressources/Images/phishing.png",
                "Ressources/Images/vpn.png", "Ressources/Images/cle_rsa.png"
            };
