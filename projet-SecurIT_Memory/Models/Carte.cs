...
namespace SecurIT_Memory.Models
{
    ...
    public class Carte
    {
        // L'identifiant sert à valider les paires. Deux cartes avec le même Id forment une paire.
        // Le 'private set' empêche la triche ou les erreurs : l'ID ne peut pas changer après la création de la carte.
        public int Id { get; private set; }

        // Chemin vers l'image de l'icône de cybersécurité (ex: "Images/virus.png")
